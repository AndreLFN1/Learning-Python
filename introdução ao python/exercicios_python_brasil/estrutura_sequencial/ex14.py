...
peso_pescado = float(input('Iai seu João, quanto o senhor pescou hoje?? '))
...
if multa == 0:
    print('O senhor não tem que pagar nenhuma multa hoje parabéns! ')
else:
    print(f'O senhor vacilou pra caralho... vai ter que pagar R${multa}!')
